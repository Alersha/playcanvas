...
AnimatePosition.attributes.add("offsetCurve", {type: "curve", title: "Offset Curve", curves: [ 'x']});
AnimatePosition.attributes.add("duration", {type: "number", default: 5, title: "Duration (secs)"});
...
AnimatePosition.prototype.initialize = function() {
    ...
    this.position = new pc.Vec3([1, 2, 3]);
